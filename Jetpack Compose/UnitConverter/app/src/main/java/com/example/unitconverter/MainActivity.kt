    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                inputValue = it
                convertUnits()
                // Here goes what should happened when the textField changes
        ...
        Row {
            ...
            Box {
                // Input Button
                Button(onClick = { iExpanded = true }, modifier = Modifier.padding(2.dp)) {
                    Text(text = inputUnit)
            ...
            Box {
                // Output Button
                Button(onClick = { oExpanded = true }, modifier = Modifier.padding(2.dp)) {
